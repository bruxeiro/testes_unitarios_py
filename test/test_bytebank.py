...
class TestClass:
    ...
    def test_quando_sobrenome_recebe_luucas_carvalho_deve_retornar_carvalho(self):
    ...
    def test_quando_calcular_bonus_recebe_100000000_deve_retornar_exception(self):
        with pytest.raises(Exception):  # Aqui o pytest testa se esta função vai retornar uma Exception
